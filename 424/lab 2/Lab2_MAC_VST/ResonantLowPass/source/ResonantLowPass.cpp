...
//-----------------------------------------------------------------------------------------
void ResonantLowPass::processReplacing(float **inputs, float **outputs, VstInt32 sampleFrames)
// overwrite output
{
...
//-----------------------------------------------------------------------------------------
void ResonantLowPass::processDoubleReplacing (double** inputs, double** outputs, VstInt32 sampleFrames)
{
    double* in1  =  inputs[0];
    double* in2  =  inputs[1];
...
//-----------------------------------------------------------------------------------------
float ResonantLowPass::knob2value(float knob, const float *limits, float taper)
...
//-----------------------------------------------------------------------------------------
float ResonantLowPass::value2knob(float value, const float *limits, float taper)
...
void ResonantLowPass::bilinearTranform(double acoefs[], double dcoefs[])
{
...
//-----------------------------------------------------------------------------------------
void ResonantLowPass::designResonantLowPass(double* dcoefs, double center, double qval)
