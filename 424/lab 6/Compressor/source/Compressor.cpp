...
void Compressor::processReplacing (float** inputs, float** outputs, VstInt32 sampleFrames)
{
	...
	for (int i = 0; i < sampleFrames; i++)
	{
        ...
        if (input > slowfiltstate)
        {
            slowfiltstate = (1 - slow_attack_amount) * slowfiltstate + slow_attack_amount * input;
        }
        else
        {
            slowfiltstate = (1 - slow_release_amount) * slowfiltstate + slow_release_amount * threshold;
        }
        ...
        {
            // release mode
            filtstate = (1 - release_amount) * filtstate + release_amount * slowfiltstate;
        }
