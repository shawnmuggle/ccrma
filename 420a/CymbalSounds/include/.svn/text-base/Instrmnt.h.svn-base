...
class Instrmnt : public Stk
{
 public:
  ...
  //! Decide how to handle global pitch bend
  virtual void setHandleGlobalPitchBend( bool val ) {};

  //! Set instrument parameters for a particular frequency.
  virtual void setFrequency( StkFloat frequency );

  //! Set frequency for a given MIDI channel
  virtual void setFrequency(StkFloat frequency, int midiChannel) {};
