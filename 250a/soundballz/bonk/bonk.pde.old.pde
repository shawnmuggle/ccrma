...
*/
  if (jerk > 200 && current_state == FREEFALL) {
    return true;
  } else {
    return false;
  }
...
{ 
  ...
  mySerial.print(133, BYTE); // 10000101 = on, noise
...
*/ 
  ...
  mySerial.print(248, BYTE); // 11111000 (loudest, 500mst)
  
  // set up osc a3 envelope decay
  mySerial.print(27, BYTE);
  mySerial.print(1, BYTE);
  mySerial.print(62, BYTE);
  mySerial.print(137, BYTE); // 10001001 (half loudness, 750ms)
}
