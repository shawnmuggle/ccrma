...
float h(float u, float v)
{
    ...
    float perturbance = 0.;
    perturbance = perturbance + 0.0019 * sin(time * 0.1) * sin(5.2 * 2. * PI * u - time / 2. + 0.4);
    perturbance = perturbance + 0.0015 * cos(time * 0.12) * cos(7.8 * 2. * PI * u - time / 5.8 - 0.1);
    perturbance = perturbance + 0.0018 * sin(time * 0.04) * sin(3.56 * 2. * PI * v - time / 1.4 + 8.4);
    perturbance = perturbance + 0.002 * cos(time * 0.16) * cos(9.79 * 2. * PI * v - time / 1.9 - 0.56);
    perturbance = perturbance + 0.0012 * sin(time * 0.01) * sin(2.87 * 2. * PI * u - time / 4.3 + 0.4);
    perturbance = perturbance + 0.0021 * cos(time * 0.07) * cos(13.3 * 2. * PI * v - time / 3.1 - 5.74);
