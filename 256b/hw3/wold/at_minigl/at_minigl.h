 ...
 */
//void mglTexCoord(MGLfloat x,	 MGLfloat y);
...
//-----------------------------------------------------------------------------
void mglPerspective( MGLfloat fovy, MGLfloat aspectRatio, MGLfloat zNear, MGLfloat zFar );	
...
// Returns the model view matrix to send to a shader
MGLfloat * mglGetModelViewMatrixPtr( );

// Returns the projection matrix to send to a shader
MGLfloat * mglGetProjectionMatrixPtr( );

// Returns the normal matrix to send to a shader
