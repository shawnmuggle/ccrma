...
// Section 2 includes a monophonic => polyphonic transition as one of the voices extends its duration over time and begins to stand out
...
[200::ms, 200::ms, 200::ms, 200::ms] @=> durations;
[now + durations[0], now + durations[1], now + durations[2], now + durations[3]] @=> nextNoteOffs;

15::second + now => time endOfSectionII;
0 => i;
0 => p;
